		...
		<div>
			<div className="relative w-full group">
				<Link
					...
					<div className="relative w-full h-[300px]">
						<Image
							...
							className="object-cover rounded-[10px] group-hover:scale-[1.09] transition duration-[1s] ease-[.4,0,.2,1]"
							priority
						/>
					</div>
				</Link>
				...
				<div
					...
					className="absolute w-fit flex top-[50%] sm:hidden xm:hidden -translate-x-[30%] -translate-y-1/2 overflow-hidden z-10 group-hover:opacity-100 opacity-0 transition duration-500 ease-[.4,0,.2,1]">
