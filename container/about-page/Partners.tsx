	...
	return (
		<section className="w-full bg-background">
			<div>
				...
				We use the proven formula trusted by
					<br className="sm:hidden xm:hidden" /> he world’s leading web development agencies
					<br className="sm:hidden xm:hidden" />
					— one that’s built long-lasting partnerships with the most ambitious brands across the globe:
